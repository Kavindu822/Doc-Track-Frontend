...
function App() {
  return (
     <Router basename="/doctrackweb/"> {/* Make sure to set basename if your app is hosted under /doctrackweb */}
      <div className="flex">
        <div className="flex-1">
          <Routes>
            {/* Public Route for Login */}
            ...
            <Route path="/admin-dashboard/employee" element={<Dyeing />} />
            <Route path="/admin-dashboard/add-files" element={<AddFiles />} />
            <Route path="/admin-dashboard/generateQR" element={<GenerateQR />} />
            <Route path="/admin-dashboard/employee/dyeing" element={<Dyeing />} />
            <Route path="/admin-dashboard/employee/quality" element={<Quality />} />
            <Route path="/admin-dashboard/employee/dyeingI" element={<DyeingI />} />
            <Route path="/admin-dashboard/admin" element={<Admin />} />
            <Route path="/admin-dashboard/transfer-file" element={<Admin />} />
            <Route path="/admin-dashboard/generateQR" element={<Admin />} />
            ...
            {/* Add route for /doctrackweb if necessary */}
            <Route path="/doctrackweb/" element={<Home />} />  {/* Or a relevant component */}
          </Routes>
        </div>
      </div>
    </Router>
